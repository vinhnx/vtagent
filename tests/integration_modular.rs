...
use vtagent_core::{
    ...
    gemini::{Client, ClientConfig, GenerateContentRequest, Content},
    
    // Test config module exports  
    config::{VTAgentConfig, ConfigManager, ToolPolicy},
    
    // Test code_completion module exports
    code_completion::{CompletionEngine, CompletionContext, CompletionKind},
