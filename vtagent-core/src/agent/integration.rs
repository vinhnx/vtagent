...
pub struct CompletedTaskInfo {
    ...
    /// Verification result
    pub verification: Option<crate::agent::verification::VerificationResult>,
...
impl MultiAgentSystem {
    ...
    pub async fn execute_task_optimized(
        ...
        let task_id_result = self.orchestrator.create_task(
            ...
            crate::agent::multi_agent::TaskPriority::Normal,
        )?;
...
pub struct OptimizedTaskResult {
    ...
    pub results: TaskResults,
    /// Verification result
    pub verification: crate::agent::verification::VerificationResult,
    /// Total execution time
    pub execution_time: Duration,
    /// Agent that executed the task
    pub agent_used: String,
    /// Performance metrics snapshot
    pub performance_metrics: crate::agent::optimization::PerformanceMetrics,
}
...
pub struct SystemStatusReport {
    ...
    pub verification_statistics: crate::agent::verification::VerificationStatistics,
    /// System recommendations
    pub recommendations: Vec<crate::agent::optimization::OptimizationStrategy>,
}
