...
impl ContextAnalyzer {
    ...
    fn detect_language(&self, source: &str) -> String {
        ...
        if let Some(language) = self.tree_sitter.detect_language_from_content(source) {
            return match language {
                crate::tree_sitter::LanguageSupport::Rust => "rust".to_string(),
                crate::tree_sitter::LanguageSupport::Python => "python".to_string(),
                crate::tree_sitter::LanguageSupport::JavaScript => "javascript".to_string(),
                crate::tree_sitter::LanguageSupport::TypeScript => "typescript".to_string(),
                crate::tree_sitter::LanguageSupport::Go => "go".to_string(),
                crate::tree_sitter::LanguageSupport::Java => "java".to_string(),
                crate::tree_sitter::LanguageSupport::Swift => "swift".to_string(),
            };
        }
    ...
    fn extract_scope(&self, source: &str, line: usize, column: usize) -> Vec<String> {
        ...
        let lang_support = match language.as_str() {
            "rust" => crate::tree_sitter::LanguageSupport::Rust,
            "python" => crate::tree_sitter::LanguageSupport::Python,
            "javascript" => crate::tree_sitter::LanguageSupport::JavaScript,
            "typescript" => crate::tree_sitter::LanguageSupport::TypeScript,
            "go" => crate::tree_sitter::LanguageSupport::Go,
            "java" => crate::tree_sitter::LanguageSupport::Java,
            _ => crate::tree_sitter::LanguageSupport::Rust,
        };
    ...
    fn extract_imports_recursive(
        ...
        source: &str,
        language: &crate::tree_sitter::LanguageSupport,
        ...
        match language {
            crate::tree_sitter::LanguageSupport::Rust => {
                if kind == "use_declaration" {
                    let import_text = &source[node.start_byte()..node.end_byte()];
                    imports.push(import_text.to_string());
                }
            }
            crate::tree_sitter::LanguageSupport::Python => {
                if kind == "import_statement" || kind == "import_from_statement" {
                    let import_text = &source[node.start_byte()..node.end_byte()];
                    imports.push(import_text.to_string());
                }
            }
            crate::tree_sitter::LanguageSupport::JavaScript
            | crate::tree_sitter::LanguageSupport::TypeScript => {
