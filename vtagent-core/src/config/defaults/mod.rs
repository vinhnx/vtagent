...
impl MultiAgentDefaults {
    pub fn max_agents() -> usize { 5 }
    pub fn max_context_size() -> usize { 100000 }
    ...
    pub fn task_timeout() -> Duration { Duration::from_secs(300) }
}
...
impl ContextStoreDefaults {
    pub fn max_size() -> usize { 100000 }
    pub fn compression() -> bool { true }
...
impl PerformanceDefaults {
    pub fn max_concurrent_operations() -> usize { 10 }
...
impl ScenarioDefaults {
    pub fn max_scenarios() -> usize { 10 }
    pub fn default_timeout() -> u64 { 300 }
    ...
    pub fn high_perf_timeout() -> Duration { Duration::from_secs(180) }
    pub fn high_quality_timeout() -> Duration { Duration::from_secs(600) }
    pub fn balanced_timeout() -> Duration { Duration::from_secs(300) }
}
