...
use crate::tools::tree_sitter::CodeAnalysis;
use anyhow::Result;
...
impl MemoryEfficientStorage {
    ...
    async fn decompress_analysis(&self, compressed: &CompressedAnalysis) -> Result<CodeAnalysis> {
        ...
        let symbols: Vec<crate::tools::tree_sitter::languages::SymbolInfo> =
        ...
        let metrics: crate::tools::tree_sitter::CodeMetrics =
        ...
        Ok(CodeAnalysis {
            ...
            language: crate::tools::tree_sitter::analyzer::LanguageSupport::Rust, // Default to Rust
            symbols,
