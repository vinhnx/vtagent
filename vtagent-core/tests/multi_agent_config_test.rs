...
fn test_multi_agent_config_loading() {
    ...
    assert_eq!(config.multi_agent.context_store.storage_dir, ".vtagent/contexts");
...
fn test_multi_agent_config_with_custom_values() {
    ...
    config.multi_agent.verification_strategy = vtagent_core::config::multi_agent::VerificationStrategy::Never;
    config.multi_agent.delegation_strategy = vtagent_core::config::multi_agent::DelegationStrategy::Aggressive;
    ...
    assert_eq!(config.multi_agent.orchestrator_model, "test/orchestrator-model");
