...
use crossterm::{
    ...
    event::{
        DisableMouseCapture, Event as CrosstermEvent, EventStream, KeyCode, KeyEvent, KeyEventKind,
...
impl RatatuiLoop {
    ...
    fn draw(&mut self, frame: &mut Frame) {
        ...
        let content_style = self
            ...
            .unwrap_or_default();
        paragraph = paragraph.style(content_style);
        ...
        if let Some(status_area) = status_area {
            if status_area.width > 0 {
                ...
                let accent_rgb = theme::accent_color();
